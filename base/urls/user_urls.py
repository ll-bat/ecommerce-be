...
urlpatterns = [
    ...
    path('products/', views.ListCreateProductsAPIView.as_view(), name="create_get_products"),
    path('products/<str:pk>/', views.ProductAPIView.as_view(), name="get_update_delete_product"),
